...
%Para limpiar valores previamente asignados
close all
clear all
clc
...
%Solucion de la condicion de eficiencia para obtener una malla de l(t)    
    ...
    for i=1:grid
        ...
        for j=1:q
            ...
            l0(j,i)=fsolve(@(l0)cond_eficiencia_laboral(l0,k0(i),k1(i),A, ...
                                                        alpha,delta,gamma,z),lini, options);
